...
- (void) viewWillLayoutSubviews {
    ...
    static const CGFloat toolbarHeight = 100;
    CGFloat width = CGRectGetWidth(self.view.bounds);
    CGFloat browserHeight = CGRectGetHeight(self.view.bounds) - itemHeight;
    
    // Now, assign the frames
    self.textField.frame = CGRectMake(0, 0, width, itemHeight);
    self.webView.frame = CGRectMake(0, itemHeight, width, browserHeight);

    self.awesomeToolbar.frame = CGRectMake(0, CGRectGetMaxY(self.textField.frame), CGRectGetWidth(self.view.bounds) - 100, toolbarHeight);
    
    self.awesomeToolbar.center = self.webView.center;
